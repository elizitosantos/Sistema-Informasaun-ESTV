...
use App\Models\ModelClasse_12Cont;
use CodeIgniter\HTTP\Request;

// use App\Models\ModelPrograma;

class Classe_12Cont extends Controller
{
     protected $request;
    ...
    protected $data;
    // Model
    protected $modelclasse_12cont;
    public function index()
    {
        $model = new ModelClasse_12Cont();
        // $data['t_clase']  = $model->getClasse()->getResult();
        $data ['v_clase12ano_dep_contabilidade']= $model->findAll();
        ...
        echo view('g_classe/view_classe_12_cont',$data);

...
use App\Models\ModelClasse_11;
use CodeIgniter\HTTP\Request;

// use App\Models\ModelPrograma;

class Classe_11 extends Controller
{
     protected $request;
    ...
    protected $data;
    // Model
    protected $modelclasse_11;
    public function index()
    {
        $model = new ModelClasse_11();
        // $data['t_clase']  = $model->getClasse()->getResult();
        $data ['v_clase11_dep_informatica']= $model->findAll();
        ...
        echo view('g_classe/view_classe_11_info',$data);
    ...
    { 
        ...
        echo view('layout/v_aside', $this->data);
        echo view('g_classe/form_classe_info', $data);
        echo view('layout/v_footer');
    }

...
use App\Models\ModelClasse_11Cont;
use CodeIgniter\HTTP\Request;

// use App\Models\ModelPrograma;

class Classe_11Cont extends Controller
{
     protected $request;
    ...
    protected $data;
    // Model
    protected $modelclasse_11cont;
    public function index()
    {
        $model = new ModelClasse_11Cont();
        // $data['t_clase']  = $model->getClasse()->getResult();
        $data ['v_clase11ano_dep_contabilidade']= $model->findAll();
        ...
        echo view('g_classe/view_classe_11_cont',$data);

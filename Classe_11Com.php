...
use App\Models\ModelClasse_11Com;
use CodeIgniter\HTTP\Request;

// use App\Models\ModelPrograma;

class Classe_11Com extends Controller
{
     protected $request;
    ...
    protected $data;
    // Model
    protected $modelclasse_11com;
    public function index()
    {
        $model = new ModelClasse_11com();
        // $data['t_clase']  = $model->getClasse()->getResult();
        $data ['v_clase11ano_dep_comercio']= $model->findAll();
             
        $data['page_title'] = "Classe_11Com";
        echo view('layout/v_head', $data);
        echo view('layout/v_header', $this->data, $this->data);
        echo view('layout/v_aside', $this->data);
        echo view('g_classe/view_classe_11_com',$data);

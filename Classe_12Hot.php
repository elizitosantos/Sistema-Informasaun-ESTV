...
use App\Models\ModelClasse_12Hot;
use CodeIgniter\HTTP\Request;

// use App\Models\ModelPrograma;

class Classe_12Hot extends Controller
{
     protected $request;
    ...
    protected $data;
    // Model
    protected $modelclasse_12Hot;
    public function index()
    {
        $model = new ModelClasse_12Hot();
        // $data['t_clase']  = $model->getClasse()->getResult();
        $data ['v_clase12ano_dep_hotelaria']= $model->findAll();
             
        $data['page_title'] = "Classe_10Cot";
        echo view('layout/v_head', $data);
        echo view('layout/v_header', $this->data, $this->data);
        echo view('layout/v_aside', $this->data);
        echo view('g_classe/view_classe_12_hot',$data);

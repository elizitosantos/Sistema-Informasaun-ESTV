...
use App\Models\ModelClasse_10;
use CodeIgniter\HTTP\Request;

// use App\Models\ModelPrograma;

class Classe_10 extends Controller
{
     protected $request;
    ...
    protected $data;
    // Model
    protected $modelclasse_10;
    public function index()
    {
        $model = new ModelClasse_10();
        // $data['t_clase']  = $model->getClasse()->getResult();
        $data ['v_clase10_dep_informatica']= $model->findAll();
        ...
        echo view('g_classe/view_classe_10_info',$data);

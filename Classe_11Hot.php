...
use App\Models\ModelClasse_11Hot;
use CodeIgniter\HTTP\Request;

// use App\Models\ModelPrograma;

class Classe_11Hot extends Controller
{
     protected $request;
    ...
    protected $data;
    // Model
    protected $modelclasse_11hot;
    public function index()
    {
        $model = new ModelClasse_11Hot();
        // $data['t_clase']  = $model->getClasse()->getResult();
        $data ['v_clase11ano_dep_hotelaria']= $model->findAll();
             
        $data['page_title'] = "Classe_11Hot";
        echo view('layout/v_head', $data);
        echo view('layout/v_header', $this->data, $this->data);
        echo view('layout/v_aside', $this->data);
        echo view('g_classe/view_classe_11_hot',$data);

...
use App\Models\ModelClasse_10Com;
use CodeIgniter\HTTP\Request;

// use App\Models\ModelPrograma;

class Classe_10Com extends Controller
{
     protected $request;
    ...
    protected $data;
    // Model
    protected $modelclasse_10com;
    public function index()
    {
        $model = new ModelClasse_10Com();
        // $data['t_clase']  = $model->getClasse()->getResult();
        $data ['v_clase10_dep_comercio']= $model->findAll();
             
        $data['page_title'] = "Classe_10Com";
        echo view('layout/v_head', $data);
        echo view('layout/v_header', $this->data, $this->data);
        echo view('layout/v_aside', $this->data);
        echo view('g_classe/view_classe_10_com',$data);
